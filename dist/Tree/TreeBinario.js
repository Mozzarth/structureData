...
var NodoTree = /** @class */ (function () {
    function NodoTree() {
    }
    NodoTree.prototype.esVacio = function () {
        return this.valor == null;
    };
    NodoTree.prototype.esHoja = function () {
        return this.valor != null && this.izq == null && this.der == null;
    };
    NodoTree.prototype.insertar = function (id) {
        if (this.valor == null) {
            this.valor = id;
            return;
        }
